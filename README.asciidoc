...
.. You may either take the chosen card into your hand or consume it for
   resources equal to the highest-value uncontrolled sector. (When a card is
   consumed, it goes into the common dead pile.)
...
.. Players may consume cards from their hand for *one* resource per card before
   paying this cost. (When a card is consumed, it goes into the common dead
   pile.)
