...
. Draw and place a new sector.
. Gain power equal to that sector's value.
. Draw cards equal to that sector's value for the market.
...
. Add your power to that total for your final score.
.. In the case of a tie, the player with the most power not in cards/disks wins.
