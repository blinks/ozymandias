...
== Parts of Play
The common board is separated into the market and the galaxy. In addition, each
...
market has fewer than 4 cards add cards from the event deck until there are
four.

=== The Galaxy
The galaxy is defined by hex-shaped sectors. At the start of the game the
universe is void and without form. Only through exploration does the universe
take shape.

Each sector has a value determined by its intrinsic value (the value on the
sector) and its improved value (the amount of influence placed on the sector).
...
== Game End
If there are no disks left in the pool at the end of any player's turn, *the game
ends.* Resolve the final effects of any active cards in the discard piles.
...
4. The player with the highest combine card and influence value wins. In case of a tie the player with the most influence wins.
