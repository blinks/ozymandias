...
On your turn, play or consume a card.  At the end of your turn, if there are no
disks left in the common pool, the game ends.  Otherwise, play proceeds
clockwise to the next player.

== Actions
There are two different actions you can take on your turn.  Each will move
...
.. [...] from your hand to your discard pile.
.. [...] from the deck to the market.
...
.. From the high-bidder down, players spend their bid to take a card from the
   market to their hand: pay the active player, you resolve the event.

. *Conquer* -- if you place in explored territory (with a sector tile):
.. Everyone whose top card matches the conquering color gains power equal to
   the sector where you placed the disk (including yourself).
.. Starting with your own, and proceeding clockwise: resolve all events that
   match either the conquering color or the conquered color (if any).
... You make decisions while resolving the conquering color's events.
... The controllers make the decisions for the conquered color's events.
